...
export type Node = SimulationNodeDatum & { id: string, label?: string } // TODO add style properties
export type Edge = SimulationLinkDatum<Node> & { label?: string } // TODO add style properties
export type Options = {
