...
import { ArrowTexture, CircleTexture, FontBook, TextIconTexture, ImageIconTexture } from '@/webgl/textures'
import { NodeRenderer, EdgeRenderer, ObjectManager } from '@/webgl/objects'
import { interpolate, logUnknownEdgeError } from '@/utils'
import { Viewport, Node, Edge, Annotation } from '@/types'
import { Zoom, Drag, Decelerate } from '@/webgl/interaction'
...
//   return {
//     update(graph: { nodes: Node[], edges: Edge[], options: Options }) {
