...
type SimulationNode = { id: string; radius: number } & SimulationNodeDatum

const COLLIDE_LAYOUT_OPTIONS = { nodePadding: 8, tick: 50 }

export const Collide = {
  Layout: () => {
    return <N extends Node, E extends Edge>(graph: { nodes: N[]; edges: E[]; options?: CollideOptions }) => {
