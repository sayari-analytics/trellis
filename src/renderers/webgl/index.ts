...
export const defaultOptions = {
  x: 0, y: 0, zoom: 1, minZoom: 0.025, maxZoom: 3,
...
export class Renderer {
  ...
  constructor ({ container, width, height, debug, forceCanvas }: {
    container: HTMLDivElement, width: number, height: number, debug?: boolean, forceCanvas?: boolean,
  }) {
