...
export type RendererOptions<N extends Graph.Node = Graph.Node, E extends Graph.Edge = Graph.Edge> = {
  width?: number
  height?: number
  x?: number
  y?: number
...
export class InternalRenderer<N extends Graph.Node, E extends Graph.Edge> {
  ...
  update: (graph: { nodes: N[]; edges: E[]; options?: RendererOptions<N, E>; annotations?: Graph.Annotation[] }) => void
  ...
  private _debugUpdate = (graph: { nodes: N[]; edges: E[]; options?: RendererOptions<N, E>; annotations?: Graph.Annotation[] }) => {
