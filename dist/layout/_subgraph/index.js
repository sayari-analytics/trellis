...
exports.Layout = exports.LAYOUT_OPTIONS = void 0;
...
var workerScript = function (DEFAULT_OPTIONS) {
    var Simulation = /** @class */ (function () {
        function Simulation(progenetorGraph) {
            ...
            this.forceLink = d3.forceLink().id(function (node) { return node.id; });
            this.forceCollide = d3.forceCollide().radius(function (node) { return node.radius + _this.nodePadding; });
            this.forceX = d3.forceX(0);
            this.forceY = d3.forceY(0);
    ...
    var simulation = new Simulation(true);
    var event;
