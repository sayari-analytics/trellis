...
export declare const parentInFront: <N extends Node<Edge<Partial<import(".").EdgeStyle>>, Partial<import(".").NodeStyle>>, E extends Edge<Partial<import(".").EdgeStyle>>>(renderer: PIXIRenderer<N, E>, parent: NodeRenderer<N, E> | undefined) => boolean;
