...
export declare const parentInFront: <N extends Node<Edge<import(".").EdgeStyle>, import(".").NodeStyle>, E extends Edge<import(".").EdgeStyle>>(renderer: InternalRenderer<N, E>, parent: NodeRenderer<N, E> | undefined) => boolean;
