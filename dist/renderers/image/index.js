...
var Renderer = function () {
    return function (graph) {
        ...
        pixiRenderer.update(__assign(__assign({}, graph), { options: __assign(__assign({}, graph.options), { animateNodePosition: false, animateNodeRadius: false, animateViewportPosition: false, animateViewportZoom: false }) }));
        return pixiRenderer
